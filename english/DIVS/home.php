...
<div id="DIVHome">
    <div class="row">
        <div class="col-md-6">
            <a href="#!/Cronograma_281_1" class="b-access petit" title="Calendario Académico" >            
        ...
        <div class="col-md-3">
            <a href="#!/Objetivos_238_1" class="b-access petit" title="Planificación" alt="Planificación">            
                <div class="img-bg" style="background-image: url(/imgDes/horaris,8.png);" alt="Planificación"></div> 
                <span class="text">Planificación</span> 
            </a> 
        </div>
        <div class="col-md-3">
            <a href="#!/Plan-de%20Estudios_282_1" class="b-access petit" title="    Descripción Módulos" alt = "   Descripción Módulos">            
    ...
    <div class="row">
        <div class="col-md-2">
            <a href="#!/Directorio-Profesores_253_1" class="b-access petit" title=" Programas" alt="  Programas">            
                <div class="img-bg" style="background-image: url(/imgDes/guiarapida,1.png);" alt="   Programas"></div> 
                <span class="text"> Programas </span> 
            </a> 
        </div>
        <div class="col-md-5">
            <a href="#!/Directorio-Profesores_253_1" class="b-access petit" title="Prácticas y trabajo de investigación" alt="Prácticas y trabajo de investigación">            
        ...
        <div class="col-md-5">
            <a href="#!/Directorio-Profesores_253_1" class="b-access petit" title="Normativa del treball d'investigació" alt="Normativa del treball d'investigació">            
