...
*/
$baseUrl_borrar = '/DocsCKeditor/';

$baseUrl = '/DocsCKeditor/';
...
ATTENTION: The trailing slash is required.
*/
$baseDir = resolveUrl($baseUrl_borrar);
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,fla,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip,msg,ics',
		'deniedExtensions' => '');
...
*/
$config['HtmlExtensions'] = array('html', 'htm', 'xml', 'js', 'ics');
